.PHONY: check rust-check vim-check installer-check help-tags vim-core defcompile

check: rust-check vim-check installer-check help-tags defcompile vim-core
